...
- Hotfix for `.ps1` and `.exe` files - Changed the orginal script to work right this time.
...
## 📁 Files Included with `Sync-Shell-PowerShell-Standalone-Edition-v1_0_1.exe` (`.exe`)
