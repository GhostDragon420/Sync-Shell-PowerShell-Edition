...
Sync-Shell is a syntax-aware, history-persistent PowerShell GUI runner with mapped output parsing.  
Built for block command execution with sync-first clarity and preview-before-execute safety.
